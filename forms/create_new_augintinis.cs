    ...
    public partial class create_new_augintinis : Form
    {
        ...
        private void gyv_kurti_Click(object sender, EventArgs e)
        {
            if (new_gyv_lytis.SelectedItem!=null && validation.MandatoryTextFieldsNotEmpty(new[] { new_gyv_vardas.Text, new_gyv_rusis.Text }))
            {
                ...
                DBupdate.add_new_to_database("gyvunas", "id", new_id, new[] { "vardas", "rusis", "veisle", "isvaizda", "lytis","zenklinimo_nr","amzius","pasas"}, new[] { new_gyv_vardas.Text, new_gyv_rusis.Text, new_gyv_veisle.Text, new_gyv_isvaizda.Text,((new_gyv_lytis.SelectedText=="Patinas") ? "1":"0"),new_gyv_zenk_nr.Text,new_gyv_amzius.Text,new_gyv_pasas.Text});
